-- Fix SQL schema issue - the table uses 'name', not 'title'
-- This script corrects the previous script that tried to use 'title' column

-- Delete any narratives that may have been incorrectly added
DELETE FROM narratives WHERE summary LIKE '%Bank of Japan ending decades%' OR summary LIKE '%Supply chain security concerns%';

-- Add corrected narratives using 'name' instead of 'title'
